...
assert_m2_dump() {
    ...
    local expected=(
        ...
        '^m2_arena_model_weight=ModelWeightArena$'
        '^m2_arena_model_weight_status=initialized$'
        '^m2_arena_model_weight_base=0x[0-9a-fA-F]*[1-9a-fA-F][0-9a-fA-F]*$'
        '^m2_arena_inference=InferenceArena$'
        '^m2_arena_inference_status=initialized$'
        '^m2_arena_inference_base=0x[0-9a-fA-F]*[1-9a-fA-F][0-9a-fA-F]*$'
        '^m2_arena_kv_cache=KVCacheArena$'
        '^m2_arena_kv_cache_status=initialized$'
        '^m2_arena_kv_cache_base=0x[0-9a-fA-F]*[1-9a-fA-F][0-9a-fA-F]*$'
        '^m2_arena_tokenizer=TokenizerArena$'
        '^m2_arena_tokenizer_status=initialized$'
        '^m2_arena_tokenizer_base=0x[0-9a-fA-F]*[1-9a-fA-F][0-9a-fA-F]*$'
        '^m2_allocator_status=alloc_smoke_ok$'
        '^UNBOUNDOS_KERNEL_STRUCTURES_BEGIN$'
        '^kernel_structures_status=initialized$'
        '^UNBOUNDOS_KERNEL_STRUCTURES_OK$'
        '^UNBOUNDOS_KERNEL_STRUCTURES_END$'
